...
\cvpub{2023}
      {23}
      {
        \textbf{Anders, E.H.}; Lecoanet, D.; Cantiello, M.; Burns, K.J.; Hyatt, B.A.; Kaufman, E.; Townsend, R.H.D.; Brown, B.P.; Vasil, G.M.; Oishi, J.S.; Jermyn, A.S. In prep.     
      }
      {The photometric variability of massive stars from gravity waves}
...
\cvpub{}
      {$^{\dagger}$21}
      {
        \textbf{Anders, E.H.} and Pedersen, M.G. Under review (Galaxies special edition).     
      }
...
\cvpub{}
      {20}
      {
        Fuentes, J.R.; Cumming, A.; Castro-Tapia, M.; \textbf{Anders, E.H.}. Under review (ApJ).
      }
